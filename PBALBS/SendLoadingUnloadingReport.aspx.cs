...
namespace PBALBS
{
    public partial class SendLoadingUnloadingReport : System.Web.UI.Page
    {
        string API_INDEX;
            ...
            foreach (DataRow member in dtMembers.Rows)
            {
                ...
                protected void btnSendNotification_Click(object sender, EventArgs e)
                {
                    ...
                    byte[] byteArray = Encoding.UTF8.GetBytes("{"
                                                            ...
                                                            + "\"contents\": {\"en\": \"PBPABS new Loading Unloading Report published.Please Login To APP and Check\"},"
