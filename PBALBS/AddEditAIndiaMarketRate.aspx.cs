...
namespace PBALBS
{
    public partial class AddEditAIndiaMarketRate : System.Web.UI.Page
    {
        ...
        protected void Save()
        {
            ...
            dt.Columns.Add("BlockWithStateId");
            dt.Columns.Add("Bond");
            dt.Columns.Add("Avg");
            dt.Columns.Add("Dala");
            DataRow dr;
            ...
            foreach (GridViewRow row in dgvBlock.Rows)
            {
                ...
                {
                    string BlockWithStateId = dgvBlock.DataKeys[row.RowIndex].Value.ToString();
                    ...
                    dr = dt.NewRow();
                    dr["BlockWithStateId"] = BlockWithStateId;
                    dr["Bond"] = Bond;
                    dr["Avg"] = Avg;
                    dr["Dala"] = Dala;
                    dt.Rows.Add(dr);
        ...
        {
            Save();
            Response.Redirect("MembershipSendSMS.aspx?day=" + ddlDay.SelectedValue.Trim() + "&month=" + ddlMonth.SelectedValue.Trim() + "&year=" + ddlYear.SelectedValue.Trim());
