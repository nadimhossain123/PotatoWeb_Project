...
namespace PBALBS
{
    public partial class MembershipSendSMS : System.Web.UI.Page
    {
        string API_INDEX;
        ...
        {
            BusinessLayer.AIndiaMarketRate ObjRate = new BusinessLayer.AIndiaMarketRate();
            ...
            try
            {
                ...
                if (message.Length <= 445)
                {
                    if (message.Length > 0)
                    {
                        ...
                        if (MobNoCount > 0)
                        {
                            ObjSMSTrigger.SavePortal(HttpContext.Current.User.Identity.Name, MobNoCount, CharCount, TotalCredit);
        ...
        private DataTable getMobileNumbers()
        {
            ...
            DataTable dtMobileNos = ObjMember.getMobileNumbers_Membership();
            return dtMobileNos;
        }
        ...
        protected void btnSendNotification_Click(object sender, EventArgs e)
        {
            ...
            byte[] byteArray = Encoding.UTF8.GetBytes("{"
                                                    ...
                                                    + "\"large_icon\" : \" " + ImageUrl + " \", "
                                                    + "\"data\": {\"NotificationType\": \"Market\"},"
                                                    + "\"contents\": {\"en\": \"PBPABS All India Market Rate published .Please Login to APP and Check if you are subscribed!!\"},"
