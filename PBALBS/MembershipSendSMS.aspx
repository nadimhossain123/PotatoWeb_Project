<%@ Page Title="Membership Send SMS" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="MembershipSendSMS.aspx.cs" Inherits="PBALBS.MembershipSendSMS" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function Validation() {
            if (document.getElementById('<%=txtMsg.ClientID %>').value.trim() == '') {
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="80%" align="center">
        ...
        <tr>
            ...
            <td>
                Total Number Of PBPABS App Downloads :  <asp:Literal ID="ltrDownloadCount" runat="server" Mode="PassThrough" ></asp:Literal>
            </td>
        </tr>
    </table>
</asp:Content>
