<%@ Page Title="Payment Receipt" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="PaymentReceipt.aspx.cs" Inherits="PBALBS.PaymentReceipt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function FillAmount()
        {
            ...
            if ((document.getElementById("<%=chkPortalMember.ClientID %>").checked == true) && (document.getElementById("<%=chkSMSsubscriber.ClientID %>").checked == false)){
                
                document.getElementById("<%=txtAmount.ClientID %>").value = "399.00";
            }
            else if ((document.getElementById("<%=chkPortalMember.ClientID %>").checked == false) && (document.getElementById("<%=chkSMSsubscriber.ClientID %>").checked == true)) {
               
                document.getElementById("<%=txtAmount.ClientID %>").value = "499.00";
            }
            else if ((document.getElementById("<%=chkPortalMember.ClientID %>").checked == true) && (document.getElementById("<%=chkSMSsubscriber.ClientID %>").checked == true)) {
                
                document.getElementById("<%=txtAmount.ClientID %>").value = "898.00";
            }
            else {
     ...
     <table width="60%" align="center">
        ...
        <tr>
            ...
            <td align="left" valign="top">
                <asp:DropDownList ID="ddlDistrict" runat="server" CssClass="dropdown" Width="250px" Height="30px" 
                    AutoPostBack="True">
                </asp:DropDownList>
         ...
         <tr>
            ...
            <td align="left" valign="top">
                ...
                <asp:ComboBox ID="ddlMember" runat="server" CssClass="WindowsStyle" DropDownStyle="DropDown"
                    AutoCompleteMode="SuggestAppend" CaseSensitive="false" Width="250px" Height="20px" AutoPostBack="True"
                    >
                </asp:ComboBox>
            </td>
            <td></td>
        ...
        <tr>
           <td align="left" class="label">
            ...
            <td align="left">
              <asp:CheckBox ID="chkPortalMember" runat="server"   Text="Portal Member" onclick="FillAmount()" />
              <br />
              <asp:CheckBox ID="chkSMSsubscriber" runat="server"   Text="SMS Subscriber" onclick="FillAmount()"/> 
              <br />
            </td>
       </tr>
         <tr>
           <td align="left" class="label">
            ...
            <td align="left">
                <asp:TextBox ID="txtAmount" runat="server" CssClass="textbox" Width="250px" Height="30px" MaxLength="8" Enabled="false"></asp:TextBox>
        ...
        <tr>
            ...
            <td align="left">
                <asp:TextBox ID="txtEntryDate" runat="server" CssClass="textbox" Width="250px" Height="30px" onkeydown="return false;"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnSave" runat="server" CssClass="button" Text="Proceed To Print" OnClick="btnSave_Click"
